...
| `data/samples/photosynthesis-vs-cellular-respiration-2page.pdf` | 兩頁繁中樣本 PDF（光合作用 vs 細胞呼吸，第 1 頁含圖表），ingestion e2e 測試用，由 PyMuPDF 產生 | 是 |
...
`data/container-mounts/` 已依上表建立子目錄結構。
